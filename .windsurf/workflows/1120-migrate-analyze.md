...
> Perform pre-migration analysis to identify custom content, missing state files, semantic references, and non-conformities before the deterministic migration apply
